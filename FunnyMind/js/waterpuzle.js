...
function ApplyInfo(a = water) {
    if (!won) {
        ...
        level.innerHTML+=`<div id = "restart" class = "game-buttons" onclick = "Restart();">REINICIAR</div><div id = "home" class = "game-buttons" onclick = "ShowMenu();">INICIO</div><div id = "moves">Movimientos: ${moves}</div>`;
    }
}
...
function Won() {
    ...
    level.innerHTML = `<div id="won">GANASTE</div><div id = "restart" class = "game-buttons" onclick = "Restart();">REINICIAR</div><div id = "home" class = "game-buttons" onclick = "ShowMenu();">INICIO</div>`;
}
